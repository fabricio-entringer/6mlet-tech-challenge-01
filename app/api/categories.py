...
class BookDataService:
    ...
    def get_categories(self, sort: str = "name", order: str = "asc", include_stats: bool = True) -> List[Category]:
        """
        ...
        """
        categories_count, prices_by_category, ratings_by_category, price_ranges = self.get_categories_data()
        ...
        for category_name, book_count in categories_count.items():
            ...
            if include_stats:
                ...
                if category_name in prices_by_category and prices_by_category[category_name]:
                    avg_price = sum(prices_by_category[category_name]) / len(prices_by_category[category_name])
                
                # Calculate average rating
                if category_name in ratings_by_category and ratings_by_category[category_name]:
                    avg_rating = sum(ratings_by_category[category_name]) / len(ratings_by_category[category_name])
...
async def get_categories(sort: str = "name", order: str = "asc", include_stats: bool = True) -> CategoriesResponse:
    """
